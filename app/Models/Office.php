...
class Office extends Model
{
    ...
    {
        return $this->hasOne(Reservation::class)->ofMany('created_at', 'min');
    }
    ...
    public function scopeNearestTo(Builder $builder, $lat, $lng)
    {
        return $builder
            ->select()
            ->orderByRaw(
                'POW(69.1 * (lat - ?), 2) + POW(69.1 * (? - lng) * COS(lat / 57.3), 2) desc',
                [$lat, $lng]
            );
    }
